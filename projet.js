...
submit.onclick = function () {
  ...
  try {
    if (!/^[A-Za-z].{3,}$/.test(title.value)) {
      throw new Error("Le titre doit contenir au moins 4 lettres");
    }
    if (!/^[0-9].{1,}$/.test(price.value)) {
      throw new Error("Le prix vide!!");
    }
    if (!/^[0-9].{1,}$/.test(taxes.value)) {
      throw new Error("taxes vide!!");
    }
    if (!/^[0-9].{1,}$/.test(ads.value)) {
      throw new Error("ads vide!!");
    }
    if (!/^[0-9].{1,}$/.test(discount.value)) {
      throw new Error("discount vide!!");
    }
    if (!/^[0-9].{1,}$/.test(count.value)) {
      throw new Error("count vide!!");
    }
    if (!/^[A-Za-z].{3,}$/.test(category.value)) {
      throw new Error(" Le category doit contenir au moins 4 lettres");
    }
